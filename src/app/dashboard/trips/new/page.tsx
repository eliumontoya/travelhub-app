...
import { ALL_CLIENTS_PAGE_SIZE, getClients, getTags, getTemplates, getTravelAgents } from "@/lib/data";
...
export default async function NewTripPage({
  ...
  const [{ items: clients }, tags, templates, travelAgents, { error, clientId }] = await Promise.all([
