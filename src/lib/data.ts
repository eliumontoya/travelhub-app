import { Client, Item, ItemDocument, SiteSettings, Tag, Trip, TripDay, TripFeedback, TripWithDetails } from "@/types";
import {
  mockClients,
  mockTrips,
  mockTripDays,
...
// 0008_trip_feedback.sql) solo permite el insert si el trip referenciado
