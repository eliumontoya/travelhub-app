import { Client, ClientDocument, Item, ItemDocument, SiteSettings, Tag, Trip, TripDay, TripWithDetails } from "@/types";
import {
  mockClients,
  mockTrips,
  mockTripDays,
...
// client_documents (ver 0008_client_documents.sql). RLS restringe estas
